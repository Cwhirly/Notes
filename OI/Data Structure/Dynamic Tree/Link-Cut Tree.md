...
听着很绕，实际上很好懂。    
画个图举例：    
![](https://cdn.luogu.com.cn/upload/image_hosting/6ip1v1bk.png)  
...
我们来具体举一个例子。  
![](https://cdn.luogu.com.cn/upload/image_hosting/upv83vin.png)  
...
![](https://cdn.luogu.com.cn/upload/image_hosting/wc8fmvo3.png)  
最后原树变成这样：  
![](https://cdn.luogu.com.cn/upload/image_hosting/jdlpluj8.png)   
说得复杂，代码很短。  
```cpp
